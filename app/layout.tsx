  ...
  return (
    <html lang="en" className="!scroll-smooth overflow-x-hidden">
      ...
      >
        ...
        <div className="bg-[#fbe2e3] absolute top-1/2 -z-10 right-[-60rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem] dark:bg-[#946263] 2xl:h-[70.25rem] 2xl:w-[100.25rem] 2xl:opacity-25 2xl:right-[-70rem]"></div>
        <div className="bg-[#dbd7fb] absolute bottom-0 -z-10 right-[-60rem] h-[20.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-20rem] xl:left-[-15rem] 2xl:h-[50.25rem] 2xl:w-[100rem] 2xl:left-[-15rem] dark:bg-[#676394] opacity-20"></div>
